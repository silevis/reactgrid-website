...
export default function Header() {
  ...
  return (
    <nav
      ...
      }  top-0 border-t-1 border-l-1 border-b-1 border-r-1 font-dm-sans border-green-light grid grid-cols-header h-[86px] text-white-primary z-50`}
    >
      ...
      <div
        className={`${
          isOpen ? "grid" : "hidden"
        } fixed md:static z-40 p-8 md:p-0 md:grid w-screen text-black-primary md:text-white-primary left-0 bg-white-primary md:bg-transparent h-screen md:w-auto md:h-auto md:relative md:grid col-start-5 col-end-13 2xl:col-start-7 2xl:col-end-11 grid-cols-1 md:grid-cols-navLinks justify-items-start md:justify-items-stretch content-start md:content-stretch md:top-auto gap-y-4 md:gap-y-0`}
      >
      ...
      <div className="absolute md:hidden right-5 top-1/2 transform -translate-y-1/2 z-50">

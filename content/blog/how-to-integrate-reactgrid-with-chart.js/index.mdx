...
description: "Creating a sample app with ReactGrid, Chart.js and Typescript"
canonicalUrl: ""
date: "2021-01-11"
tags:
...
1. `getChartData` - this function should return an object that contains two fields. The `labels` - which is an array of frequency title label
  ...
  You can also style your line by setting for example a `backgroundColor` or `pointRadius` for a better experience.

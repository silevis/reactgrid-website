...
see the [`Row`](/docs/4.0/7-api/0-interfaces/2-row/) interface.
...
its location. This callback provides location ([`CellLocation`](/docs/4.0/7-api/0-interfaces/6-cell-location/)) parameter.

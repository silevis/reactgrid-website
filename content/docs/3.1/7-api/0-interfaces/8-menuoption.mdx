...
| `handler`     | `(selectedRowIds: `[`Id`](/docs/3.1/7-api/1-types/4-id/)[]`, selectedColIds: `[`Id`](/docs/3.1/7-api/1-types/4-id/)`[], selectionMode: `[`SelectionMode`](/docs/3.1/7-api/1-types/7-selection-mode/))` => void`   | Function that is called when option is clicked |
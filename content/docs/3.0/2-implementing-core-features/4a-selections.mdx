...
- this top cell of the column, the whole column will be selected, then you can expand this selection to other columns.

You can then select and unselect any row/column by <kbd>Ctrl</kbd> or <kbd>Command ⌘</kbd> key.

...
This cell render text value with possibility to validate it's own value and wrap result into `React.ReactNode` objects.
...
```tsx
class class EmailCellTemplate implements CellTemplate<EmailCell> {

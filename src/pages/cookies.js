                        ...
                        <Col>
                          ...
                          <Nav justified className="mt-5">
                            <NavItem className="success">
                              <NavLink href="#what-are-cookies" className="h4">
                                <Button className="btn-simple" color="success">What Are Cookies</Button>
                              </NavLink>
                            </NavItem>
                            <NavItem>
                              <NavLink href="#how-we-use-cookies" className="h4">
                                <Button className="btn-simple" color="success">How We Use Cookies</Button>
                              </NavLink>
                            </NavItem>
                            <NavItem>
                              <NavLink href="#disabling-cookies" className="h4">
                                <Button className="btn-simple" color="success">Disabling Cookies</Button>
                              </NavLink>
                            </NavItem>
                            <NavItem>
                              <NavLink href="#the-cookies-we-set" className="h4">
                                <Button className="btn-simple" color="success">The Cookies We Set</Button>
                              </NavLink>
                            </NavItem>
                            <NavItem>
                              <NavLink href="#third-party-cookies" className="h4">
                                <Button className="btn-simple" color="success">Third Party Cookies</Button>
                              </NavLink>
                            </NavItem>
                            <NavItem>
                              <NavLink href="#more-information" className="h4">
                                <Button className="btn-simple" color="success">More infomations</Button>
                              </NavLink>
                            </NavItem>
                          </Nav>
                        </Col>
